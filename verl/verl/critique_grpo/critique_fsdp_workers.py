...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if rollout_name == "hf":
            ...
            if vllm_mode == "customized":
                ...
                from .critique_vllm_rollout_spmd import CRITIQUEvLLMRollout

                vllm_rollout_cls = CRITIQUEvLLMRollout if self.config.rollout.mode == "sync" else vLLMAsyncRollout
    ...
    def init_model(self):
        ...
        if self._is_actor:
            ...
            ### actor w/ critique model
            from .critique_dp_actor import CRITIQUEDataParallelPPOActor
            self.actor = CRITIQUEDataParallelPPOActor(config=self.config.actor, actor_module=self.actor_module_fsdp, actor_optimizer=self.actor_optimizer)
